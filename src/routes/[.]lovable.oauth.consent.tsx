    ...
    <main className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-md space-y-5 rounded-lg border border-border bg-card p-6 shadow-sm">
        <div className="space-y-2">
          <h1 className="text-xl font-semibold text-foreground">Conectar {clientName} ao Lívia CRM</h1>
          <p className="text-sm text-muted-foreground">
            {clientName} poderá usar as ferramentas do Lívia CRM como você: ler e atualizar leads e conversas,
            enviar mensagens no WhatsApp e operar campanhas. As permissões seguem exatamente o seu acesso.
          </p>
        </div>
        {error && (
